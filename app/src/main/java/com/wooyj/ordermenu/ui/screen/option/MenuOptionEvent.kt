...
sealed class MenuOptionEvent {
    ...
    data class ClickCaffeineOption(val caffeineOption: OptionButtonUiState) : MenuOptionEvent()

    data class ClickIceOption(val iceOption: OptionButtonUiState) : MenuOptionEvent()
}
